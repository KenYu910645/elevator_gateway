...
CLIENT_NAME = "test" # Tow different mqtt client MUST have different name, and '#' , '+' , '/' is NOT allow in topic name
is_ev_available = ""
...
if __name__ == '__main__':
	...
	while True:
		...
		if mqtt_obj.available == "offline":
			...
			if is_ev_available == "online" and mqtt_obj.available == "online": 
				...
				rc = mqtt_obj.publish(topic = CLIENT_NAME+"/elevator_server/cmd", payload = paylaod_dict, qos = 2, retain = False)
				if rc == None: 
